        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black text-white">
            <div className="max-w-7xl mx-auto min-h-screen grid lg:grid-cols-2 items-center px-8">
                <div className="hidden lg:flex flex-col justify-center">
                    ...
                    <p className="text-slate-400 text-xl mt-6 max-w-lg">Your AI-powered learning platform. Generate complete courses, solve doubts, prepare for interviews, analyze resumes, practice coding and learn faster.</p>
                ...
                <div className="flex justify-center">
                    <div className="w-full max-w-md bg-slate-900/80 backdrop-blur-xl border border-slate-700 rounded-3xl shadow-[0_0_40px_rgba(59,130,246,0.18)] p-10">
                        ...
                        <button onClick={handleLogin} disabled={loading || googleLoading} className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:scale-[1.02] disabled:opacity-60 disabled:cursor-not-allowed transition-all duration-300 rounded-xl py-4 font-bold">
